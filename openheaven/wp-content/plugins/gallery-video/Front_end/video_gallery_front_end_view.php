							...
							function getresult(pagenum,perpage,galleryid,thumbtext,width,height){
								...
								jQuery.post('<?php echo admin_url("admin-ajax.php"); ?>',data,function(response){
									if(response.success){
										...
										jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?> img').on('load',function(){
											jQuery('#huge_it_videogallery_container_<?php echo $videogalleryID; ?>').hugeitmicro({ sortBy: 'original-order' }) .hugeitmicro( 'reLayout' ).hugeitmicro( 'reloadItems' ); jQuery(window).resize();
											//############# Hakob
											...
											jQuery(".videogroup<?php echo $videogalleryID; ?>").vcolorbox({rel:'videogroup<?php echo $videogalleryID; ?>'});
											jQuery(".youtube").vcolorbox({iframe:true, innerWidth:640, innerHeight:390});
											jQuery(".vimeo").vcolorbox({iframe:true, innerWidth:640, innerHeight:390});
											jQuery(".iframe").vcolorbox({iframe:true, width:"80%", height:"80%"});
											jQuery(".inline").vcolorbox({inline:true, width:"50%"});
											jQuery(".callbacks").vcolorbox({
												onOpen:function(){ alert('onOpen: vcolorbox is about to open'); },
...
//console.log(jQuery(".video_view9_img"));
</script>
...
<script>
	jQuery(document).ready(function() {
  jQuery('.thumb_wrapper').on('click', function(ev) {
  	var hugeid=jQuery(this).parent().parent().index();
  	var myid=hugeid;
  	myid=parseInt(myid)/2;

  	//alert(myid);

 	//console.log(jQuery(this).parent().parent().index());
